...
export default function Login() {
  ...
  function handleSubmit(event) {
    ...
    // --- ☢️ NUCLEAR DEMO FIX ☢️ ---
    // This manually forces the connection for your demo user
    if (formData.username === 'richard01') {
        console.log("Forcing manual override for richard01 -> REST-ACM");
        localStorage.setItem('restaurant_id', 'REST-ACM');
        localStorage.setItem('restaurantId', 'REST-ACM');
    }
    // -----------------------------
    ...
    login(
      ...
      formData.password,
      formData.role ?? 'owner',
      formData.role === 'owner' ? formData.restaurantId.trim() || undefined : undefined
    );
  }
